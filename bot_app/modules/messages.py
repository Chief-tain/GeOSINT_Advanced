...
"\- Создание интерактивной карты выбранных территорий;\n" \
"\- Создание интерактивной карты по ключевым словам;\n" \
"\- Создание перечня информационно\-новостных сообщений по ключевым словам;\n" \
...
"\n" \
+ markdown.bold("2. Режим создания интерактивной выбранных территорий:\n") +\
"Бот получает границы временного интервала, названия областей, затем создает интерактивную карту\.\n" \
+ markdown.bold("Команда: /region_map\n") + \
"\n" \
+ markdown.bold("3. Режим создания интерактивной карты по ключевым словам:\n") +\
...
"\n" \
+ markdown.bold("4. Режим создания перечня информационно-новостных сообщений по ключевым словам:\n") +\
"Бот получает границы временного интервала и ключевое слово, затем создает перечень новостных сообщений по ключевому слову и семантически близким к нему\.\n" \
+ markdown.bold("Команда: /tag_list\n") + \
"\n" \
+ markdown.bold("5. Режим создания общей информационно-новостной сводки:\n") +\
"Бот получает границы временного интервала и создает краткую информационно\-новостную сводку\.\n" \
+ markdown.bold("Команда: /fast_news\n") + \
"\n" \
+ markdown.bold("6. Режим создания краткой новостной сводки по населенному пункту:\n") +\
...
"\n" \
+ markdown.bold("7. Режим создания информационно-отчетного документа:\n") +\
